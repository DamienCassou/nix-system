update-raspberrypi:
	...
	ssh -t raspberrypi sudo nixos-rebuild boot --flake ~/personal/nix-system/

update-luz5:
	rsync --archive --progress --delete ./ luz5:~/personal/nix-system/
	ssh -t luz5 sudo nixos-rebuild boot --flake ~/personal/nix-system/

update-pepite:
	rsync --archive --progress --delete ./ pepite:~/personal/nix-system/
	ssh -t pepite sudo nixos-rebuild boot --flake ~/personal/nix-system/
